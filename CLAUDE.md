...
A reusable **park-and-re-enter** primitive that pauses the pipeline at a cheap seam so the user can intervene before the expensive build. Two seams ship: the **design checkpoint** (VIB-1877) and **plan mode** as the heaviest variant (VIB-1880, see below).
